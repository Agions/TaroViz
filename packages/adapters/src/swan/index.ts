...
/**
 * 百度智能小程序环境下的ECharts适配器
 */
class SwanAdapter implements Adapter {
  private instance: any = null;
  private options: EnhancedSwanAdapterOptions;
  private canvasId: string;
  private ctx: any = null;
  private component: any = null;
  private canvasDom: any = null;

  constructor(options: EnhancedSwanAdapterOptions) {
  ...
  render(): JSX.Element {
    ...
    // 使用React.createElement替代JSX语法，避免TS错误
    return React.createElement(Canvas, {
      type: '2d',
      id: this.canvasId,
      style: mergedStyle,
      className: 'taroviz-echarts-swan',
    });
  }
}
