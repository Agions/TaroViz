...
/**
 * 水球图组件
 * 需要引入echarts-liquidfill扩展
 */
const LiquidFillChart: React.FC<LiquidFillChartProps> = ({
  option,
  width = '100%',
  height = '300px',
  theme,
  ...
  const chartId = useRef<string>(`liquid-fill-chart-${uuid()}`);
  ...
  return (
    <View 
      className={`taroviz-liquid-fill-chart ${className}`}
      style={mergedStyle}
