...
import { TreemapChart as TreemapChartComponent } from 'echarts/charts';
import {
  TooltipComponent,
  TitleComponent,
  LegendComponent,
...
const TreemapChart: React.FC<TreemapChartProps> = ({
  ...
  const chartId = useRef<string>(`treemap-chart-${uuid()}`);
  ...
  return (
    <View
      className={`taroviz-treemap-chart ${className}`}
      style={mergedStyle}
